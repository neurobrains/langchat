...
description: Supabase database integration for chat history and metrics. The Supabase Adapter provides integration with Supabase PostgreSQL database for storing chat history, metrics, and feedback.
---

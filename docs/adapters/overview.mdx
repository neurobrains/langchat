...
description: Overview of LangChat adapters and their functionality
---

import { Card, CardGroup } from 'mintlify';
import { Callout } from 'mintlify';

LangChat uses a modular adapter architecture. Each adapter handles integration with external services.

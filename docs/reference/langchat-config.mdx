...
<Param name="verbose_chains" type="bool" default="False">
  Show LangChain verbose output for debugging chains (standalone question chain and main QA chain). When enabled, shows detailed prompt formatting and chain execution logs in Rich panels.
</Param>
...
- `VERBOSE_CHAINS` - Enable verbose chain output for debugging (default: "False")
...
config = LangChatConfig(
    ...
    # Note: Use single braces {context}, {chat_history}, {question} for template variables

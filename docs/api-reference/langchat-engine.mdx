...
description: LangChatEngine API reference
---

import { Param } from 'mintlify';
import { Callout } from 'mintlify';

# LangChatEngine API Reference

The `LangChatEngine` class is the core orchestrator that manages all LangChat components.

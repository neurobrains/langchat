...
description: Configuration class API reference with all LangChat configuration options
---
...
<ParamField path="openai_api_keys" type="List[str]" required>
  List of OpenAI API keys. Can provide multiple keys for automatic rotation.
</ParamField>

<ParamField path="openai_model" type="str" default="gpt-4o-mini">
  OpenAI model to use. Options: "gpt-4o-mini", "gpt-4o", "gpt-4-turbo", "gpt-3.5-turbo"
</ParamField>

<ParamField path="openai_temperature" type="float" default="1.0">
  Model temperature (0.0-2.0). Higher = more creative, lower = more focused
</ParamField>

<ParamField path="openai_embedding_model" type="str" default="text-embedding-3-large">
  OpenAI embedding model. Options: "text-embedding-3-large", "text-embedding-3-small", "text-embedding-ada-002"
</ParamField>

<ParamField path="pinecone_api_key" type="str | None" default="None">
  Pinecone API key
</ParamField>

<ParamField path="pinecone_index_name" type="str | None" default="None">
  Pinecone index name (must be pre-created)
</ParamField>

<ParamField path="supabase_url" type="str | None" default="None">
  Supabase project URL
</ParamField>

<ParamField path="supabase_key" type="str | None" default="None">
  Supabase API key (anon or service role)
</ParamField>

<ParamField path="retrieval_k" type="int" default="5">
  Number of documents to retrieve from vector search
</ParamField>

<ParamField path="reranker_top_n" type="int" default="3">
  Number of top documents after reranking
</ParamField>

<ParamField path="reranker_model" type="str" default="ms-marco-MiniLM-L-12-v2">
  Flashrank reranker model name
</ParamField>

<ParamField path="reranker_cache_dir" type="str" default="rerank_models">
...
<ParamField path="memory_window" type="int" default="20">
  Conversation buffer window size
</ParamField>

<ParamField path="timezone" type="str" default="Asia/Dhaka">
  Timezone for date/time formatting
</ParamField>

<ParamField path="system_prompt_template" type="str | None" default="None">
...
<ParamField path="max_llm_retries" type="int" default="2">
  Maximum retry attempts per API key
</ParamField>

<ParamField path="server_port" type="int" default="8000">
  Port for API server
</ParamField>

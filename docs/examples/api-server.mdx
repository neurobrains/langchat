---
title: API Server
description: Run LangChat as a FastAPI server with auto-generated frontend interface. Run LangChat as a FastAPI server with an auto-generated frontend interface and Dockerfile.
---

---
title: Vector Search
description: Learn about vector search and RAG (Retrieval-Augmented Generation) in LangChat
---
...
<Callout type="info">
Learn about vector search and RAG (Retrieval-Augmented Generation) in LangChat
</Callout>

LangChat integrates powerful vector search capabilities for Retrieval-Augmented Generation (RAG). This guide explains how vector search works.

...
description: Learn how to customize prompts for your LangChat application
---
...
<Callout type="info">
Learn how to customize prompts for your LangChat application
</Callout>

Prompts are the instructions that guide your chatbot's behavior. LangChat allows you to fully customize both system prompts and standalone question prompts.
...
- **[API Reference](/api-reference/langchat-config)** - Full configuration API

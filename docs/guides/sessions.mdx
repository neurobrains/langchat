...
description: Understand how LangChat manages user sessions and chat history. LangChat automatically manages user sessions, chat history, and conversation context. This guide explains how sessions work.
---
...
- **[API Reference](/reference/user-session)** - Full session API
- **[Vector Search](/guides/vector-search)** - Learn about vector search integration

---

Questions? Check the [API Reference](/reference/user-session) for complete details!

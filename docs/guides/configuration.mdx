---
title: Configuration
description: Complete guide to configuring LangChat
---
...
<Callout type="info">
Complete guide to configuring LangChat
</Callout>

LangChat is highly configurable. This guide covers all configuration options available in `LangChatConfig`.

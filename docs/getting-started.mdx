...
description: Get up and running with LangChat in minutes
---

import { Card, CardGroup } from 'mintlify';
import { Callout } from 'mintlify';

# Getting Started with LangChat

Welcome! This guide will help you build your first LangChat application in just a few minutes.
...
- **[API Reference](/api-reference/langchat)** - Learn about all available methods

...
# Note: This script requires a utils module with Package, die, and for_each_package
# If these utilities are not available, this script may not work as expected
try:
